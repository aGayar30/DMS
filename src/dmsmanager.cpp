...
eyegazeComponent(framesQueue, eyegazeDetectionQueue,commandsQueue,faultsQueue),
...
eyegazeDetectionQueue(eyegazeDetectionQueue), framesQueue(framesQueue),
